      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center mb-12">
          <div className="md:w-1/3 mb-6 md:mb-0 md:mr-12">
            ...
            >
              <img
                src="https://i.postimg.cc/L47dRDFL/TH55.jpg"
                alt="Profile"
          ...
          <div className="md:w-2/3">
            <span className="text-4xl font-bold mb-4 text-center md:text-left bg-gradient-to-r from-indigo-900 via-purple-900 to-pink-900 text-transparent bg-clip-text dark:from-white dark:via-purple-800 dark:to-pink-800">
              My Learning Journey 
            </span><span className='text-4xl mb-4'>📚</span>
