...
import { SiTypescript, SiDjango, SiTensorflow, SiPytorch, SiMongodb,SiFirebase, SiNextdotjs, SiQwiklabs, SiAstro, SiDocker, SiPostman, SiCanva } from 'react-icons/si';
...
const skills = [
  ...
  { name: 'Express.js', category: 'Backend', level: 90, icon: FaNodeJs, color: '#339934', bgColor: '#E6FFE6' },
  ...
  { name: 'Firebase', category: 'Database', level: 80, icon: SiFirebase, color: '#FFCA28', bgColor: '#FFF8E1' },
