...
export default function Resume() {
  ...
  const education = [
    { degree: 'BSc in Computer Science & Engineering ', institution: 'The International University of Scholars, Banani, Dhaka', year: '2021-2025', color: 'bg-indigo-500' }
  ]
    ...
    >
      ...
      >
        ...
        <motion.header variants={fadeInUp} className="text-center">
          ...
          >
            <img src="https://i.postimg.cc/bvZ99xdH/T12.jpg" alt="MyProfileImage" width={160} height={160} className="object-cover" />
          </motion.div>
          <motion.h1
...
{/*           <motion.p
        ...
        <motion.section variants={fadeInUp}>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              { icon: '📧', text: 'Email', href: 'tamannahemi123@gmail.com' },
              { icon: '📞', text: 'Phone', href: '01720421802' },
              { icon: '💼', text: 'LinkedIn', href: 'https://www.linkedin.com/feed/' },
              { icon: '🐙', text: 'GitHub', href: 'https://github.com/TamannaHemi333' }
            ].map((item, index) => (
              <motion.a
                key={index}
                href={item.href}
        ...
        <motion.footer variants={fadeInUp} className="text-center">
          <motion.a
            target='_blank'
            href="https://drive.google.com/file/d/1H1dsRxnPY7uKeooTYT9XP6OLY33wKMP6/view"
            download
